package com.test.deceframe.spring.neo4j.config;
...
public class Neo4JServerLiveTest {
    ...
    public void standAloneJdbc() throws Exception {
        Connection con = DriverManager.getConnection("jdbc:neo4j:bolt://localhost/?user=neo4j,password=test,scheme=basic");
